...
<body>
    ...
    <div class="sidebar" id="sidebar">
        <a href="{{ route('dashboard') }}" class="brand ajax-link">
            <i class="fa fa-cubes"></i> HR-Management
        </a>
        <ul class="sidebar-menu">
            <li><a href="{{ route('dashboard') }}" class="ajax-link"><i class="fa fa-home"></i> Dashboard</a></li>
            <li><a href="{{ route('department.index') }}" class="ajax-link"><i class="fa fa-building"></i>
                    Departments</a></li>
            <li><a href="{{ route('employees.index') }}" class="ajax-link"><i class="fa fa-users"></i> Employees</a>
            </li>

            <li><a href="{{ route('attendance.report') }}" class="ajax-link"><i class="fa fa-chart-bar"></i> Attendance
                    Report</a></li>
            <li><a href="{{ route('leave.request') }}" class="ajax-link"><i class="fa fa-calendar-alt"></i> Leave
                    Requests</a></li>
        </ul>
    </div>
    ...
    <div class="main-wrapper">
        <div class="topbar">
            <div>
                ...
                <h5 class="mb-0 d-inline-block ms-2">Welcome, HR Admin</h5>
            </div>
